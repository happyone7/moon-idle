...
const RESEARCH_BRANCHES = [
  ...
  { id:'O', label:'자동화',    nodes:['auto_worker','auto_build','auto_parts','auto_assembly','auto_fuel','auto_launch','auto_research','auto_prestige'], unlockReq:'hire_worker_1' },
  { id:'X', label:'전문화',    nodes:['spec_sales_pro','spec_sysadmin','spec_experiment','spec_analyst'],   unlockReq:'auto_worker' },
...
const BUILDING_UPGRADES = {
  housing: [
    ...
    { id:'housing_sport',  name:'★ 단지 내 체육관',     cost:{money:7000000},                         desc:'전체 생산 +12%',                  prodBonus:0.12, premium:true, req:'housing_market' },
    { id:'housing_rctr',   name:'★ 연구 기숙사',        cost:{money:40000000},                        desc:'자금 생산 +20% · 전체 생산 +5%',  moneyBonus:0.20, prodBonus:0.05, premium:true, req:'housing_sport' },
    { id:'housing_smart',  name:'★ 스마트 커뮤니티',    cost:{money:200000000},                       desc:'전체 생산 +15%',                  prodBonus:0.15, premium:true, req:'housing_rctr' },
    { id:'housing_mega',   name:'★ 메가시티 단지',      cost:{money:1200000000},                      desc:'자금 생산 +30% · 전체 생산 +10%', moneyBonus:0.30, prodBonus:0.10, premium:true, req:'housing_smart' },
    { id:'housing_luna',   name:'★ 루나 드림 빌리지',   cost:{money:7000000000},                      desc:'전체 생산 +25%',                  prodBonus:0.25, premium:true, req:'housing_mega' },
  ],
  ops_center: [
