...
| `verify-ascii-rendering` | ASCII 건물 렌더링 일관성 검증 (폰트 정의, 기반부 정렬, 박스 외폭 일치, 선행 공백 규칙) | `js/world.js`, `js/tabs/launch.js`, `index.html`, `mockups/ascii-art/**/*.txt`, `Docs/ASCII_Building_Guide.md` |
