...
- web-build-deploy: Web deploy — /web-build-deploy beta (surge.sh), /web-build-deploy live (GitHub Pages). (file: .claude/skills/web-build-deploy/SKILL.md)
- web-steam-build-deploy: Electron EXE + Steam upload — /web-steam-build-deploy dev|qa|release. (file: .claude/skills/web-steam-build-deploy/SKILL.md)
